...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="min-h-screen dark:bg-black bg-white flex flex-col items-center py-0 md:pb-20 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.70] sm:scale-50"
    >
      <motion.h2
        style={{
...
const MrTechnologies = () => {
  return (
    <img src={"/MrTechnologies/logo-dark.webp"} alt="MR TECHNOLOGIES LOGO" className="object-contain aspect-video h-20" />
  );
};
